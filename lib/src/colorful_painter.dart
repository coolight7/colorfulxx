...
class ColorfulxxGradientPainter extends CustomPainter {
  /// Creates an [ColorfulxxGradientPainter].
  ///
  /// Requires a [FragmentShader] to apply the mesh gradient effect, a [double] value for time to animate the gradient,
  /// a list of [Color]s to define the gradient colors, and [ColorfulxxGradientOptions] to customize the animation.
  const ColorfulxxGradientPainter({
  ...
  bool shouldRepaint(covariant ColorfulxxGradientPainter oldDelegate) =>
